  ...
  const renderWindDirectionTicks = ({ payload, x, y }) => {
    ...
    return (
      <g transform={`translate(${x},${y + 10})`} textAnchor="middle">
        <g transform={`rotate(${rotationDegrees}, 6, 6)`}>
          {" "}
          {/* Rotation appliquée directement ici
        le 6,6 correspond au centre de l'image (si comme ici elle fait 12 pixels, le 0,0 correspond au coin supérieur gauche) */}
          <TbArrowDownTail fontSize="12px" />{" "}
          {/* Supprimer transform du style */}
        </g>
      </g>
    );
  };
  ...
  <ResponsiveContainer width={width} height={500}>
        ...
        >
          ...
          <Bar
            ...
            xAxisId="time"
            fill="#303C6D"
            barSize={10} // Ajustez cette valeur selon vos besoins
          />
